...
describe('layout', function () {
    describe('sidebar', function () {
        ...
        it('should have isCurrent() for / to return `current`', function () {
            $httpBackend.when('GET', 'app/modules/dashboard/views/dashboard.view.html').respond(200);
            $location.path('/');
            $httpBackend.flush();
            $rootScope.$apply();
        ...
        it('should have isCurrent() for /avengers to return `current`', function () {
            $httpBackend.when('GET', 'app/modules/avengers/views/avengers.view.html').respond(200);
